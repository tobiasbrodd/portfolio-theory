...
# Black-Litterman
function black_litterman(R_historic, R_market, risk_free_rate, P, Q, tau, w; long = false)
    ...
    mu_bl, sigma_bl = estimate(P, Q, sigma, theta, tau)
...
function estimate(P, Q, sigma, theta, tau)
...
function test()
    ...
    return black_litterman(R_historic, R_market, risk_free_rate, P, Q, tau, w)
end
